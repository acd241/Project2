...
public static Pair Bot3TestStationaryMouseAVG(double alpha){
    ...
    public static void main(String args[]){
        ...
        System.out.println();
        System.out.print("MomTotal Sensing and Movement values. Sense: " + SMMoving.getKey() + " Movement: " +SMMoving.getValue());
        */
        ...
        /* 
        Pair SMiceMoving = Bot3TestMovingMice(0.4);
        System.out.println();
        ...
        */
        ...
        int skip1 = 0;
        for(int i = 0; i< 50; i++){
            Pair SenseMovement1 = Bot3TestStationaryMouseAVG(0.2);
        ...
        */
        ...
        int skip4 = 0;
        for(int i = 0; i< 50; i++){
            Pair SenseMovement4 = Bot3TestMovingMiceAVG(0.2);
